...
public class JiaoshiController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		JiaoshiEntity user = jiaoshiService.selectOne(new EntityWrapper<JiaoshiEntity>().eq("yonghuming", username));
    ...
    public R register(@RequestBody JiaoshiEntity jiaoshi){
    	...
    	JiaoshiEntity user = jiaoshiService.selectOne(new EntityWrapper<JiaoshiEntity>().eq("yonghuming", jiaoshi.getyonghuming()));
		if(user!=null) {
			return R.error("注册教师已存在");
		}
